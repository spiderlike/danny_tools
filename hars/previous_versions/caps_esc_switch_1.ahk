...
white_click(PositionX = 1333, PositionY = 666) {
  CoordMode, Mouse, Screen
  MouseMove, %PositionX%, %PositionY%, 0
  Send {Click %PositionX% %PositionY% Left}
return
}
...
sc02b & 5:: run, cmd.exe /c c:\windows\system32\taskmgr.exe, ,Hide
...
!b::send, {LControl down}{Left down}{LControl up}{Left up}
!w::send, {LControl down}{Right down}{LControl up}{Right up}

LAlt & sc027::send, {Enter}
LAlt & p::send, {backspace}
LAlt & u::send, {LControl down}{backspace down}{LControl up}{backspace up}

f2 & ,::send, {PgDn}
f2 & sc034::send, {PgUp}

sc02b & 4::send {Media_Next}
sc02b & 2::send {Media_Prev}
sc02b & 3::send {Media_Play_Pause}
...
RAlt & x::WinMinimize, A
RAlt & a::WinMaximize, A

f5 & i::ResizeWinLeftHalfUp()
f5 & ,::ResizeWinLeftHalfDown()
f5 & sc035::ResizeWinRightHalfDown()
f5 & p::ResizeWinRightHalfUp()
f5 & o::ResizeWinHalfStart()
f5 & sc034::ResizeWinHalfEnd()
